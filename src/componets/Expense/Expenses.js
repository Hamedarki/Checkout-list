...
const Expenses = (props) =>{
   ...
   return(
      <div>
                  <ExpenseFilter selected={filterdYear} onSelectYear ={expenseFilterHandler}/>
         <div className="expenses" >
            {/* TODO:should refactor names */}
            {props.items.map((expense,index)  => <ExpenseItem key={index} title={expense.title} cost={expense.author} date={expense.publishedAt}/>)}
